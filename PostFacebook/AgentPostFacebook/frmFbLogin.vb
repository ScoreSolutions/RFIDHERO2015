...
Public Class frmFbLogin
    ...
    Private Sub frmFbLogin_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Dim fbLoginUrl = FacebookUtilities.GenerateLoginUrl(ConfigurationManager.AppSettings("appId").ToString(), "manage_pages,publish_stream,read_stream")
        Dim fbLoginUrl = FacebookUtilities.GenerateLoginUrl(ConfigurationManager.AppSettings("appId").ToString(), "manage_pages,read_stream")
