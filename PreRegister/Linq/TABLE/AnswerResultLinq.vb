...
Namespace TABLE
    'Represents a transaction for ANSWER_RESULT table Linq.
    '[Create by  on October, 24 2011]
    Public Class AnswerResultLinq
        Public sub AnswerResultLinq()

        End Sub 
        ' ANSWER_RESULT
        Const _tableName As String = "ANSWER_RESULT"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into ANSWER_RESULT table successfully.
        ...
        '/// Returns an indication whether the current data is updated to ANSWER_RESULT table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from ANSWER_RESULT table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of ANSWER_RESULT by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of ANSWER_RESULT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As AnswerResultLinq
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of ANSWER_RESULT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Long, trans As SQLTransaction) As AnswerResultPara
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of ANSWER_RESULT by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("point")) = False Then _point = Convert.ToDouble(Rdr("point"))
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As AnswerResultLinq
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of ANSWER_RESULT by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As AnswerResultPara
            ClearData()
            _haveData  = False
            Dim ret As New AnswerResultPara
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("point")) = False Then ret.point = Convert.ToDouble(Rdr("point"))
        ...
        'Get Insert Statement for table ANSWER_RESULT
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_ON, UPDATE_BY, UPDATE_ON, ANSWER_ID, QUESTIONNAIRE_QUESTION_ID, CHOICE_TYPE_ID, RESULT_CHOICE_NAME, POINT)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_ANSWER_ID) & ", "
                sql += DB.SetDouble(_QUESTIONNAIRE_QUESTION_ID) & ", "
                sql += DB.SetDouble(_CHOICE_TYPE_ID) & ", "
                sql += DB.SetString(_RESULT_CHOICE_NAME) & ", "
                sql += DB.SetDouble(_POINT)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        'Get update statement form table ANSWER_RESULT
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "ANSWER_ID = " & DB.SetDouble(_ANSWER_ID) & ", "
                Sql += "QUESTIONNAIRE_QUESTION_ID = " & DB.SetDouble(_QUESTIONNAIRE_QUESTION_ID) & ", "
                Sql += "CHOICE_TYPE_ID = " & DB.SetDouble(_CHOICE_TYPE_ID) & ", "
                Sql += "RESULT_CHOICE_NAME = " & DB.SetString(_RESULT_CHOICE_NAME) & ", "
                Sql += "POINT = " & DB.SetDouble(_POINT) + ""
                Return Sql
            End Get
        End Property


        'Get Delete Record in table ANSWER_RESULT
        ...
        'Get Select Statement for table ANSWER_RESULT
