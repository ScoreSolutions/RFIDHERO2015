...
Namespace TABLE
    'Represents a transaction for ANSWER table Linq.
    '[Create by  on October, 24 2011]
    Public Class AnswerLinq
        Public sub AnswerLinq()

        End Sub 
        ' ANSWER
        Const _tableName As String = "ANSWER"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into ANSWER table successfully.
        ...
        '/// Returns an indication whether the current data is updated to ANSWER table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from ANSWER table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of ANSWER by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of ANSWER by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As AnswerLinq
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of ANSWER by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Long, trans As SQLTransaction) As AnswerPara
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of ANSWER by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As AnswerLinq
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        'Child Table Name : ANSWER_RESULT Column :answer_id
                        Dim AnswerResult_answer_idItem As New AnswerResultLinq
                        _ANSWER_RESULT_answer_id = AnswerResult_answer_idItem.GetDataList("answer_id = " & _ID, "", Nothing)
        ...
        '/// Returns an indication whether the Class Data of ANSWER by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As AnswerPara
            ClearData()
            _haveData  = False
            Dim ret As New AnswerPara
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        'Child Table Name : ANSWER_RESULT Column :answer_id
                        Dim AnswerResult_answer_idItem As New AnswerResultLinq
                        _ANSWER_RESULT_answer_id = AnswerResult_answer_idItem.GetDataList("answer_id = " & ret.id, "", Nothing)
                        ret.CHILD_ANSWER_RESULT_answer_id = _ANSWER_RESULT_answer_id
        ...
        'Get Insert Statement for table ANSWER
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_ON, UPDATE_BY, UPDATE_ON, QUESTIONNAIRE_ID, ANSWER_DATE, ANSWER_NAME, SESSION_ID)"
                Sql += " VALUES("
                ...
                sql += DB.SetDateTime(_ANSWER_DATE) & ", "
                sql += DB.SetString(_ANSWER_NAME) & ", "
        ...
        'Get update statement form table ANSWER
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "ANSWER_DATE = " & DB.SetDateTime(_ANSWER_DATE) & ", "
                Sql += "ANSWER_NAME = " & DB.SetString(_ANSWER_NAME) & ", "
        ...
        'Get Delete Record in table ANSWER
        ...
        'Get Select Statement for table ANSWER
