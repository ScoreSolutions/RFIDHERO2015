    ...
    Public Class SqlDB
        ...
        Protected Shared ReadOnly Property ConnectionString() As String
            Get
                Dim ret As String = ""
                Try
                    ret = "Data Source=" & DataSource() & ";Initial Catalog=" & DbName() & ";User ID=" & DbUserID() & ";Password=" & DbPwd()
        ...
        Public Shared Function GetDateNowFromDB(ByVal trans As SqlTransaction) As String
            Dim ret As New DateTime(1, 1, 1)
        ...
        Public Shared Function SplitText(ByVal txt As String, ByVal txtSeperate As String) As String()
            Dim ret As String() = {}
            If txt.Trim <> "" Then
                ret = Split(txt, txtSeperate)
            End If
