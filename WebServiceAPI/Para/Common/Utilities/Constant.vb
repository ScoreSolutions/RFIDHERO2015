Namespace Common.Utilities
    Public Class Constant
        ...
        Partial Public Class FieldName
            ...
            Public Const CREATE_ON As String = "CREATE_ON"
            Public Const UPDATE_BY As String = "UPDATE_BY"
            Public Const UPDATE_ON As String = "UPDATE_ON"
        End Class
        ...
        Partial Public Class BookType
            Public Const ReceiveOutsideID As Long = 1      'ประเภทหนังสือที่รับมาจากภายนอก
            Public Const BookRequestID As Long = 2      'ประเภทหนังสือที่เป็นคำขอรับการส่งเสริม
            Public Const BookRequestOtherSystem As Long = 3    'ประเภทหนังสือที่มาจากระบบงานอื่น
        End Class
    End Class
